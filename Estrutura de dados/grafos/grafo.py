class Graph:
    ...
    def count_components(self):
        ...
        self.visited = [False] * self.n  # Cria um vetor que indica se um vértice já foi visitado ou não
    ...
    def dfs(self, current):
        ...
        for i in range(1,len(self.adj[current])):  # Itera por todos os vizinhos de current
